...
import { mockedUsersData } from "../../../../shared/testUtils/mockedData";
        ...
        renderWithProviders(
          <MemoryRouter>
            <QueryClientProvider client={queryClient}>
              <Customers isMaxWidth600px={false} isMaxWidth1025={false} />
            </QueryClientProvider>
          </MemoryRouter>
        );
      });
    ...
    describe("with a width of resolution below 600px", () => {
      beforeEach(() => {
        ...
        renderWithProviders(
          <MemoryRouter>
            <QueryClientProvider client={queryClient}>
              <Customers isMaxWidth600px={true} isMaxWidth1025={true} />
            </QueryClientProvider>
          </MemoryRouter>
        );
      });
