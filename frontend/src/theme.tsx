...
function reverseTokens(tokensDark: { [key: string]: { [key: string]: string } }) {
	const reversedTokens: { [key: string]: { [key: string]: string } } = {}

	Object.entries(tokensDark).forEach(([key, val]: [string, typeof tokensDark[keyof typeof tokensDark]]) => {
